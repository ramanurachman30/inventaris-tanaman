    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                @yield('content')
                <div class="judul text-dark" style="font-family: 'Courier New', Courier, monospace">
                    <center>
                    <h1>TENTANG Website</h1>
                    </center>
                </div>
                <div class="text-white ml-3" size="100px">
                    <h1 style="color:rgb(29, 201, 14); font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Website ini berfungsi untuk menginformasikan tentang tanaman-tanaman yang ada di SMK Wikrama Bogor. Deskripsi, Jumlah, gambar semua lengkap ada di website ini. Website ini juga berfungsi sebagai web untuk memonitor penyiraman tanaman otomatis.</h1>
                </div>
                <!-- /.container-fluid -->
